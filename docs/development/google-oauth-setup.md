...
This guide explains how to set up Google OAuth authentication for the TimeClout application.
...
4. Configure the following:
   - **Name**: TimeClout Web Client
   - **Authorized JavaScript origins**:
     - `http://localhost:3000` (for development)
     - `https://app.timeclout.com` (for production)
   - **Authorized redirect URIs**:
     - `http://localhost:3000/api/v1/auth/callback/google` (for development)
     - `https://app.timeclout.com/api/v1/auth/callback/google` (for production)
5. Click **Create**
...
1. In the Google Cloud Console, go to **APIs & Services** > **OAuth consent screen**
2. Add your domain (`timeclout.com`) to the **Authorized domains** section
3. Save the changes
