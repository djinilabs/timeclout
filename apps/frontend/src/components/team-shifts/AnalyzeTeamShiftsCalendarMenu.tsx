...
export interface AnalyzeTeamShiftsCalendarMenuProps {
  ...
  setAnalyzeWorkerSlotEquality: (analyzeWorkerSlotEquality: boolean) => void;
  analyzeWorkerSlotProximity: boolean;
  setAnalyzeWorkerSlotProximity: (analyzeWorkerSlotProximity: boolean) => void;
}
    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center">
            <LabeledSwitch
              label={
                <Trans>
                  Require a minimum number of shifts in a standard workday for
                  each worker each week
                </Trans>
              }
        ...
        <div className="flex flex-col gap-2 lg:border-l lg:pl-4">
          <LabeledSwitch
            label={<Trans>Analyze worker inconvenience equality</Trans>}
            checked={analyzeWorkerInconvenienceEquality}
            onChange={setAnalyzeWorkerInconvenienceEquality}
          />
          <LabeledSwitch
            label={<Trans>Analyze worker slot equality</Trans>}
            checked={analyzeWorkerSlotEquality}
            onChange={setAnalyzeWorkerSlotEquality}
          />
          <LabeledSwitch
            label={<Trans>Analyze worker slot proximity</Trans>}
            checked={analyzeWorkerSlotProximity}
            onChange={setAnalyzeWorkerSlotProximity}
          />
        </div>
      </div>
    </div>
