...
> = ({ day }) => {
  const form = useForm<CreateScheduleShiftPositionForm>({
    defaultValues: {
      day,
      badges: [
        { name: "Badge 1", color: "gray-500" },
        { name: "Badge 2", color: "red-500" },
        { name: "Badge 3", color: "yellow-500" },
      ],
    },
      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <p className="mt-1 text-sm/6 text-gray-600">
            Create a position in the team schedule.
          </p>
                  ...
                  <div className="mt-2">
                    <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                      <DayPicker
                        ...
                        onSelect={(d) =>
                          d && field.handleChange(new DayDate(d))
                        }
                      />
                    </div>
                  </div>
