...
export const TeamCalendarIntegrations = () => {
  ...
  const url = `${window.location.origin}/api/v1/ical/teams/${teamPk}/shifts`;
  return (
    <div className="mt-4">
      ...
      <ul role="list" className="divide-y divide-gray-100">
        <li className="flex items-center gap-x-2 py-5">
          ...
          <span className="text-sm/6 text-gray-500">
            <Trans>Team shifts calendar</Trans>
          </span>
          <input
          ...
          <button
            ...
            className="ml-2 rounded-md p-1 text-gray-400 hover:text-gray-500"
